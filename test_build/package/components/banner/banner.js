...
var BannerComponent = function BannerComponent(_ref) {
    ...
    var transitions = (0, _reactSpring.useTransition)(
        (customizationOptions === null || customizationOptions === void 0
            ? void 0
            : customizationOptions.imageHeader) || null,
        function (item) {
    ...
    var bannerImageCredits =
        customizationOptions === null || customizationOptions === void 0
            ? void 0
            : (_customizationOptions = customizationOptions.imageHeader) === null || _customizationOptions === void 0
            ? void 0
            : _customizationOptions.credits;
    return /*#__PURE__*/ _react.default.createElement(
        ...
        isEditing &&
            ...
            /*#__PURE__*/ _react.default.createElement(_edit_header_image_button.EditHeaderImageButton, {
        ...
        transitions === null || transitions === void 0
            ...
            : transitions.map(function (_ref2) {
                  ...
                  return (
                      item &&
                      /*#__PURE__*/ _react.default.createElement(_reactSpring.animated.img, {
                          key: key,
        ...
        /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(_user_informations.UserInformations, null),
            /*#__PURE__*/ _react.default.createElement(
                _social_actions.SocialActions,
                null,
                actionsButtons,
                mode === 'edit' && /*#__PURE__*/ _react.default.createElement(_edit_button.EditButton, null),
                mode === 'edit' &&
                    /*#__PURE__*/ _react.default.createElement(_customize_button.CustomizeButton, {
                        customizationOptions: customizationOptions
                    })
            )
        ),
        (bannerImageCredits === null || bannerImageCredits === void 0 ? void 0 : bannerImageCredits.name) &&
            /*#__PURE__*/ _react.default.createElement(
                _ui.Typography,
                {
                    customClasses: {
                ...
                /*#__PURE__*/ _react.default.createElement(_reactIntl.FormattedMessage, {
                    ...
                    values: {
                        ...
                        unsplashLink: /*#__PURE__*/ _react.default.createElement(
                            'a',
                            {
                                href: encodeURI(

...
var styles = function styles(theme) {
    ...
    var QUERY_BETWEEN_MEDIUM_SMALL = (0, _styles_utils.createScreenWidthMediaQuery)(
        'max-width',
    ...
    return {
        ...
        overlay: {
            extend: 'absolutePositioned',
            zIndex: 1,
            backgroundImage: 'linear-gradient(360deg, rgba('
                .concat(darkenPrimaryRgb, ', .9) -28.58%, rgba(')
                .concat(primaryRgb, ', 0.7) 93.05%)')
        },

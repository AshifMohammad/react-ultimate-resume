...
var EditHeaderImageButton = function EditHeaderImageButton(_ref) {
    ...
    var _useReceivedGlobalCla = (0, _use_received_global_classes.useReceivedGlobalClasses)(
            'banner.editHeaderImageButton'
        ),
        ...
        function (value) {
            if (typeof onCustomizationChanged === 'function') {
                onCustomizationChanged(
                    _objectSpread({}, customizationOptions, {
                        imageHeader: value
                    })
                );
            }
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        null,
        /*#__PURE__*/ _react.default.createElement(_edit_banner_image_dialog.EditBannerImageDialog, {
            open: open,
            onClose: onClose,
        ...
        mode === 'edit' &&
            /*#__PURE__*/ _react.default.createElement(_bouncing_round_button.BouncingRoundButton, {

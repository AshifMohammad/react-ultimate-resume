...
var Results = function Results(_ref2) {
        ...
        function (_ref3) {
            ...
            return function () {
                onSelect({
                    ...
                    credits: {
                        url: encodeURI(
                            ''.concat(user.links.html, '?utm_source=W3D Developer Profile&utm_medium=referral')
                        ),
                        name: user.username
                    },
                    fromUnsplash: true
                ...
                fetch(
                    ''
                        .concat(endpoints === null || endpoints === void 0 ? void 0 : endpoints.unsplashProxy, '?url=')
                        .concat(links.download_location)
                );
            };
        },
        [onSelect]
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        showLoadingSpinner && /*#__PURE__*/ _react.default.createElement(_loading_spinner.LoadingSpinner, null),
        !showLoadingSpinner &&
            (results === null || results === void 0
                ? void 0
                : results.map(function (_ref4) {
                      var id = _ref4.id,
                          urls = _ref4.urls,

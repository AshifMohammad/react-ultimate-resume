...
var YearMonthComponent = function YearMonthComponent(_ref) {
    ...
    var onPickerChange = (0, _react.useCallback)(
        function (newValue) {
            if (newValue === null) {
                onChange(null);
                return;
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(
                _ui.TextField,
                (0, _extends2.default)({}, textfieldProps, {
                    variant: variant,
...
var YearMonth = (0, _react.memo)(YearMonthComponent, function (nextProps, oldProps) {
    return (0,
    _isEqual.default)((0, _pick.default)(nextProps, ['value', 'error', 'onChange']), (0, _pick.default)(oldProps, ['value', 'error', 'onChange']));
});

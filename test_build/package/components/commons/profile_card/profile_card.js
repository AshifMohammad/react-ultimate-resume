...
var ProfileCardComponent = function ProfileCardComponent(_ref) {
    ...
    var _useReducer = (0, _react.useReducer)(
            _profile_card_reducer.profileCardReducer,
            (0, _profile_card_reducer.getProfileCardInitialState)({
                variant: variant,
                side: sideProps
            })
        ),
    ...
    var transitionsSpringProps = (0, _react.useMemo)(
        function () {
    ...
    var setSide = (0, _react.useCallback)(
        function (newSide) {
            if (sideProps) {
                return;
            }
    ...
    var handleMouseEnter = (0, _react.useCallback)(
        function () {
    ...
    var editButtonTransitions = (0, _reactSpring.useTransition)(
        isEditingProfile,
        function (item) {
    ...
    var contextData = (0, _react.useMemo)(
        function () {
            return {
                state: state,
                dispatch: dispatch
        ...
        /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(
                ...
                transitions.map(function (_ref3) {
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        _profile_card_side.ProfileCardSide,
                        {
                            key: key,
                            style: props
                        },

...
var _Poweredby_100pxWhite_VertText = _interopRequireDefault(
    require('../../../assets/images/Poweredby_100px-White_VertText.png')
);
...
var Results = function Results(_ref2) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        loading && /*#__PURE__*/ _react.default.createElement(_loading_spinner.LoadingSpinner, null),
        !loading &&
            gifs &&
            debouncedQuery &&
            gifs.map(function (_ref3) {
                var id = _ref3.id,
                    url = _ref3.url,
                    title = _ref3.title;
                return /*#__PURE__*/ _react.default.createElement(

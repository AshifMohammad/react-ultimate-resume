...
var TechnologyItem = function TechnologyItem(_ref) {
    ...
    var selectedItem = (0, _react.useMemo)(
        function () {
    ...
    var selectedItemLayerTransitions = (0, _reactSpring.useTransition)(
        selectedItem,
        function (selected) {
...
var AllTechnologiesPickerComponent = function AllTechnologiesPickerComponent(_ref4) {
    ...
    var displayedItems = (0, _react.useMemo)(
        function () {
            return Object.values(technologies !== null && technologies !== void 0 ? technologies : {})
                ...
                .filter(function (_ref7) {
                    var name = _ref7.name,
                        tags = _ref7.tags;
                    return []
                        .concat((0, _toConsumableArray2.default)(tags !== null && tags !== void 0 ? tags : []), [name])
                        .some(function (value) {
    ...
    var displayedItemsTransitions = (0, _reactSpring.useTransition)(
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        isMobile &&
            /*#__PURE__*/ _react.default.createElement(_checkbox_group.CheckboxField, {

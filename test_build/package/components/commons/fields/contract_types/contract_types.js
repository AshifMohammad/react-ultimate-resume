...
var ContractType = function ContractType(_ref) {
    ...
    if (contracts.length <= 1) {
        return /*#__PURE__*/ _react.default.createElement(_reactIntl.FormattedMessage, {
            ...
            values: {
                contractType: (0, _capitalize.default)(
                    formatMessage(
                        _contract_types_translations.default[lastContract] ||
                            _contract_types_translations.default.unknown
                    )
                )
            }
        });
    ...
    return /*#__PURE__*/ _react.default.createElement(_reactIntl.FormattedMessage, {
        ...
        values: {
            ...
            contracts: contracts
                .map(function (key) {
                    return (0,
                    _capitalize.default)(formatMessage(_contract_types_translations.default[key] || _contract_types_translations.default.unknown));
                })
                .join(', ')
        }
    });

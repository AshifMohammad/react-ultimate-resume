...
var useUnsplashResults = function useUnsplashResults(input) {
    ...
    (0, _react.useEffect)(
        function () {
            ...
            if (
                input === (lastLoaded === null || lastLoaded === void 0 ? void 0 : lastLoaded.input) &&
                page === (lastLoaded === null || lastLoaded === void 0 ? void 0 : lastLoaded.page)
            ) {
                return;
            }
                    ...
                    .then(
                        /*#__PURE__*/ (function () {
                            var _ref3 = (0, _asyncToGenerator2.default)(
                                /*#__PURE__*/ _regenerator.default.mark(function _callee(res) {
                                    var functionResult;
                                            ...
                                            switch ((_context.prev = _context.next)) {
                                                ...
                                                case 3:
                                                    ...
                                                    if (
                                                        !''
                                                            .concat(
                                                                functionResult === null || functionResult === void 0
                                                                    ? void 0
                                                                    : functionResult.unsplashStatus
                                                            )
                                                            .startsWith('2')
                                                    ) {
                                                        _context.next = 6;
                    ...
                    .then(function (res) {
                        ...
                        setResults(
                            res === null || res === void 0
                                ...
                                ? void 0
                                : _res$data.results.map(function (_ref4) {
                                      var id = _ref4.id,
                                          user = _ref4.user,

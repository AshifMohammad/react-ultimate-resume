...
var LanguageItem = (0, _reactSortableHoc.SortableElement)(function (_ref2) {
    ...
    var handleLanguageChange = (0, _react.useCallback)(
        function (e) {
            return onChange(index, 'language', e.target.value);
        },
        [index]
    );
    var handleValueChange = (0, _react.useCallback)(
        function (e) {
            ...
            /*#__PURE__*/ _react.default.createElement(
                ...
                /*#__PURE__*/ _react.default.createElement(
                    ...
                    /*#__PURE__*/ _react.default.createElement(
                        ...
                        formatMessage(_languages_edit_dialog_translations.default.language)
                    ),
                ...
                /*#__PURE__*/ _react.default.createElement(
                    ...
                    /*#__PURE__*/ _react.default.createElement(
                        ...
                        formatMessage(_languages_edit_dialog_translations.default.level, {
                            valueNode: /*#__PURE__*/ _react.default.createElement(
                                'span',
                                {
...
var SortableLanguagesItems = (0, _reactSortableHoc.SortableContainer)(function (_ref3) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        items === null || items === void 0
            ? void 0
            : items.map(function (language, index) {
                  return /*#__PURE__*/ _react.default.createElement(
                      LanguageItem,
                      (0, _extends2.default)(
                          {
...
var LanguagesEditFormWrapper = function LanguagesEditFormWrapper(_ref6) {
    ...
    var languageDeleted = (0, _react.useCallback)(
        function (deletingId) {
            return function () {
                handleValueChange('languages')(
                    languages.filter(function (_ref7) {
                        var id = _ref7.id;
    ...
    var addLanguage = (0, _react.useCallback)(
        function () {
            ...
            handleValueChange('languages')(
                [].concat(
                    (0, _toConsumableArray2.default)(languages !== null && languages !== void 0 ? languages : []),
                    [
                        {
                            index:
                                (_languages$length =
                                    languages === null || languages === void 0 ? void 0 : languages.length) !== null &&
                                _languages$length !== void 0
                                    ? _languages$length
                                    : 0,
                            id: id
                        }
    ...
    var move = (0, _react.useCallback)(
        function (_ref8) {
            ...
            handleValueChange('languages')(
                (0, _reactSortableHoc.arrayMove)(languages, oldIndex, newIndex).map(function (data, index) {

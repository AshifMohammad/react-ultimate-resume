...
var LanguagesBackComponent = function LanguagesBackComponent(_ref) {
    ...
    var classes = useStyles({
        itemSize:
            (_data$languages$lengt =
                (_data$languages = data.languages) === null || _data$languages === void 0
                    ? void 0
                    : _data$languages.length) !== null && _data$languages$lengt !== void 0
                ? _data$languages$lengt
                : 0
    });
...
var Content = function Content(_ref2) {
    ...
    var transitions = (0, _reactSpring.useTransition)(
        (_data$languages2 = data.languages) !== null && _data$languages2 !== void 0 ? _data$languages2 : [],
        function (_ref3) {
            var id = _ref3.id;
        ...
        _objectSpread({}, _languages_back_spring_props.LANGUAGES_COLUMN_TRANSITIONS_SPRING_PROPS, {
            trail:
                (175 * 3) /
                ((_data$languages3 = data === null || data === void 0 ? void 0 : data.languages) !== null &&
                _data$languages3 !== void 0
                    ? _data$languages3
                    : []
                ).length
        })
    ...
    var _useMemo = (0, _react.useMemo)(
            function () {
                return {
                    backColor: (0, _styles_utils.getHexFromPaletteColor)(
                        theme,
                        (0, _styles_utils.getColorsFromCardVariant)(theme, variant).backColor
                    ),
                    backBackgroundColor: (0, _styles_utils.getHexFromPaletteColor)(
                        theme,
                        (0, _styles_utils.getColorsFromCardVariant)(theme, variant).backBackgroundColor
                    )
                };
            },
            [theme, variant]
    ...
    var colorPalette = (0, _react.useMemo)(
        function () {
            ...
            return Array.from(
                {
                    length:
                        (_data$languages$lengt2 =
                            (_data$languages4 = data.languages) === null || _data$languages4 === void 0
                                ? void 0
                                : _data$languages4.length) !== null && _data$languages$lengt2 !== void 0
                            ? _data$languages$lengt2
                            : 0
                },
                function (v, k) {
    ...
    var hasLanguage = (0, _react.useMemo)(
        function () {
            return (0, _exists_and_not_empty.existsAndNotEmpty)(
                data === null || data === void 0 ? void 0 : data.languages
            );
        },
        [data]
    );
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        transitions.map(function (_ref4, index) {
            ...
            var item = _ref4.item,
                ...
                props = _ref4.props;
            return /*#__PURE__*/ _react.default.createElement(
                _language_column.LanguageColumn,
                {
                    itemsSize:
                        (_data$languages$lengt3 =
                            (_data$languages5 = data.languages) === null || _data$languages5 === void 0
                                ? void 0
                                : _data$languages5.length) !== null && _data$languages$lengt3 !== void 0
                            ? _data$languages$lengt3
                            : 0,
                    key: key,
                ...
                /*#__PURE__*/ _react.default.createElement(
                    ...
                    (_item$language = item.language) === null || _item$language === void 0
                        ? void 0
                        : _item$language.substring(0, 2).toUpperCase()
                )
            );
        })
    );

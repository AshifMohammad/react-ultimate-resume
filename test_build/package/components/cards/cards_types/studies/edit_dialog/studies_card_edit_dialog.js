...
var FormationsEditFormWrapper = function FormationsEditFormWrapper(_ref3) {
    ...
    var formationDeleted = (0, _react.useCallback)(
        function (deletedId) {
            return function () {
                handleValueChange('education')(
                    education.filter(function (_ref4) {
                        var id = _ref4.id;
                        return deletedId !== id;
                    })
                );
    ...
    var formationAdded = (0, _react.useCallback)(
        function () {
            var id = (0, _v.default)();
            return handleValueChange('education')(
                [].concat((0, _toConsumableArray2.default)(education), [
                    {
...
var SelectComponent = (0, _react.memo)(function (_ref6) {
    ...
    var selectYearItems = (0, _react.useMemo)(function () {
        return (0, _range.default)(1980, (0, _moment.default)().year() + 8)
            .sort(function (a, b) {
                return b - a;
            })
            .map(function (year) {
...
var FormationItem = (0, _reactSortableHoc.SortableElement)(function (_ref7) {
    ...
    var handleInstitutionChange = (0, _react.useCallback)(
        function (event) {
            return onChange(index, 'institution', event.target.value);
        },
        [index]
    );
    var handleStudyType = (0, _react.useCallback)(
        function (event) {
            return onChange(index, 'studyType', event.target.value);
        },
        [index]
    );
    var handleAreaChange = (0, _react.useCallback)(
        function (event) {
    ...
    var contentTransitions = (0, _reactSpring.useTransition)(
        ...
        function (item) {
            return ''
                .concat(item ? 'visible' : 'invisible', '_study_')
                .concat(item === null || item === void 0 ? void 0 : item.id, '_content');
        },
        _objectSpread(
            {},
            _studies_edit_dialog_spring_props.STUDIES_CONTENT_TRANSITION_SPRING_PROPS,
            {
                unique: true
            },
                            ...
                            /*#__PURE__*/ _react.default.createElement(
                                ...
                                /*#__PURE__*/ _react.default.createElement(_ui.TextField, {
                                    ...
                                    placeholder: formatMessage(
                                        _studies_translations.translations.mainCoursePlaceholder
                                    ),
...
var SortableFormationsItems = (0, _reactSortableHoc.SortableContainer)(function (_ref9) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
        _ui.List,
        null,
        items.map(function (formation, index) {
            return /*#__PURE__*/ _react.default.createElement(
                FormationItem,
                (0, _extends2.default)(
                    {

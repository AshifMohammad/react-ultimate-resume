...
var Content = function Content(_ref2) {
    ...
    var onChangePerks = (0, _react.useCallback)(
        function (newPerks) {
            return handleValueChange('perks')(
                _objectSpread(
                    {},
    ...
    var onChangeCurrentJobIssues = (0, _react.useCallback)(
        function (newCurrentJobIssues) {
            return handleValueChange('currentJobIssues')(
                _objectSpread(
                    {},
            ...
            return handleValueChange('perks')(
                _objectSpread(
                    ...
                    (0, _defineProperty2.default)(
                        {},
                        _job_perks_utils.JobPerks.OTHER,
                        perks[_job_perks_utils.JobPerks.OTHER] !== null ? null : ''
                    )
                )
            );
        },
            ...
            return handleValueChange('currentJobIssues')(
                _objectSpread(
                    ...
                    (0, _defineProperty2.default)(
                        {},
                        _job_issues_utils.JobIssues.OTHER,
                        currentJobIssues[_job_issues_utils.JobIssues.OTHER] !== null ? null : ''
                    )
                )
            );
        },

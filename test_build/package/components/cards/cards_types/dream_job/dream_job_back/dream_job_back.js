...
var DreamJobBackComponent = function DreamJobBackComponent(_ref) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        (0, _exists_and_not_empty.existsAndNotEmpty)(places) &&
            /*#__PURE__*/ _react.default.createElement(
                _profile_card_section.ProfileCardSection,
                null,
                /*#__PURE__*/ _react.default.createElement(DreamJobLocations, {
                    places: places,
                    remoteFrequency: remoteFrequency,
                    classes: classes
                })
            ),
        (0, _exists_and_not_empty.existsAndNotEmpty)(isFreelance ? averageDailyRate : salary) &&
            (isFreelance ? averageDailyRate !== '0' : salary !== '0') &&
            /*#__PURE__*/ _react.default.createElement(
                _profile_card_section.ProfileCardSection,
                null,
                /*#__PURE__*/ _react.default.createElement(
                    _dream_job_salary_section_content.DreamJobSalarySectionContent,
                    {
        ...
        (0, _exists_and_not_empty.existsAndNotEmpty)(contractTypes) &&
            /*#__PURE__*/ _react.default.createElement(
                _profile_card_section.ProfileCardSection,
                null,
                /*#__PURE__*/ _react.default.createElement(
                    _profile_card_section_title.ProfileCardSectionTitle,
                    null,
                ...
                /*#__PURE__*/ _react.default.createElement(
                    _profile_card_section_text.ProfileCardSectionText,
                    null,
                    /*#__PURE__*/ _react.default.createElement(_contract_types.ContractType, {
                        contractTypes: contractTypes
                    })
                )
            ),
        (0, _exists_and_not_empty.existsAndNotEmpty)(perks) &&
            (0, _typeof2.default)(perks) === 'object' &&
            Object.values(perks).some(function (value) {
            ...
            /*#__PURE__*/ _react.default.createElement(
                ...
                /*#__PURE__*/ _react.default.createElement(
                    _profile_card_section_text.ProfileCardSectionText,
                    null,
                    /*#__PURE__*/ _react.default.createElement(_dream_job_perks.DreamJobPerks, {
                        perks: perks
                    })
                )
            ),
        (0, _exists_and_not_empty.existsAndNotEmpty)(currentJobIssues) &&
            /*#__PURE__*/ _react.default.createElement(
                _profile_card_section.ProfileCardSection,
                null,
                /*#__PURE__*/ _react.default.createElement(
...
var DreamJobLocations = function DreamJobLocations(_ref2) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement(
            _profile_card_section_text.ProfileCardSectionText,
            null,
            /*#__PURE__*/ _react.default.createElement(DreamJobPlaces, {
                places: places,
                classes: classes
            }),
            ...
            remoteFrequency &&
                formatMessage(
                    _remote_filter_translations.remoteDisplayTranslations[remoteFrequency] ||
                        _remote_filter_translations.remoteDisplayTranslations.others
                )
        )
    );
};
    ...
    if (!remainingPlaces.length) {
        ...
        return /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(_reactIntl.FormattedMessage, {
                ...
                values: {
                    place:
                        (_firstPlace$name = firstPlace === null || firstPlace === void 0 ? void 0 : firstPlace.name) !==
                            null && _firstPlace$name !== void 0
                            ? _firstPlace$name
                            : ''
                }
            })
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(_reactIntl.FormattedMessage, {
                ...
                defaultMessage:
                    'I want to work in {place} and {length, plural, one {one other place} other {# other places}}',
                values: {

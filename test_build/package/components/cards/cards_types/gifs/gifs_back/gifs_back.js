...
var GifsBackComponent = function GifsBackComponent(_ref) {
    ...
    var handleBeforeChange = (0, _react.useCallback)(
    ...
    var pauseSlider = (0, _react.useCallback)(function () {
        ...
        return (_sliderReference$curr = sliderReference.current) === null || _sliderReference$curr === void 0
            ? void 0
            : _sliderReference$curr.slickPause();
    }, []);
    var resumeSlider = (0, _react.useCallback)(function () {
        var _sliderReference$curr2;

        return (_sliderReference$curr2 = sliderReference.current) === null || _sliderReference$curr2 === void 0
            ? void 0
            : _sliderReference$curr2.slickPlay();
    }, []);
    return /*#__PURE__*/ _react.default.createElement(
        _gifs_sides_commons.GifsSidesCommons,
        {
            underLayer: /*#__PURE__*/ _react.default.createElement(
                'div',
                {
                ...
                /*#__PURE__*/ _react.default.createElement(
                    ...
                    ((_data$interests = data.interests) !== null && _data$interests !== void 0
                        ? _data$interests
                        : []
                    ).map(function (_ref2) {
...
var Content = function Content(_ref3) {
    ...
    var hasHobby = (0, _react.useMemo)(
        function () {
            return (0, _exists_and_not_empty.existsAndNotEmpty)(
                data === null || data === void 0 ? void 0 : data.interests
            );
        },
        [data]
    );
    var transitions = (0, _reactSpring.useTransition)(
        (_data$interests$curre =
            (_data$interests2 = data.interests) === null || _data$interests2 === void 0
                ? void 0
                : _data$interests2[currentIndex]) !== null && _data$interests$curre !== void 0
            ? _data$interests$curre
            : {},
        function (item) {
    ...
    return transitions.map(function (_ref4) {
        ...
        return (
            ...
            /*#__PURE__*/ _react.default.createElement(TransitioningItem, {
                item: item,
                key: key,
                props: props,
                classes: classes,
...
var Arrow = function Arrow(_ref5) {
    ...
    var handleMouseUp = (0, _react.useCallback)(
        function () {
    ...
    return /*#__PURE__*/ _react.default.createElement(
        _reactSpring.animated.button,
        {
            onClick: onClick,
            className: (0, _classnames.default)(
                classes.arrow,
                arrowRole === 'next' && classes.nextArrow,
                arrowRole === 'prev' && (0, _classnames.default)(classes.reverseArrow, classes.prevArrow)
            ),
            type: 'button',

...
var _url_fallback_dialog = require('../../../../../commons/url_fallback_dialog.jsx/url_fallback_dialog');
...
var GifsEditFormComponent = function GifsEditFormComponent(_ref) {
    ...
    var hasGiphyKey = (0, _react.useMemo)(
        function () {
            return !!apiKeys.giphy;
        },
        [apiKeys.giphy]
    );
    ...
    var interestDeleted = (0, _react.useCallback)(
        function (id) {
    ...
    var addInterest = (0, _react.useCallback)(
        function () {
            var id = (0, _v.default)();
    ...
    var move = (0, _react.useCallback)(
        function (_ref4) {
            ...
            handleValueChange('interests')(
                (0, _reactSortableHoc.arrayMove)(interests, oldIndex, newIndex).map(function (data, index) {
    ...
    var handleGifSelection = (0, _react.useCallback)(
        function (_ref5) {
            var url = _ref5.url,
                query = _ref5.query;
    ...
    var handleGifChange = (0, _react.useCallback)(
        function (url) {
            interestChanged(selectedIndex, 'gifUrl', url);
        },
        [interestChanged, selectedIndex]
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        null,
        hasGiphyKey &&
            /*#__PURE__*/ _react.default.createElement(_search_gifs_dialog.SearchGifsDialog, {
                open: Boolean(selectedIndex !== null),
                onClose: removeSelectedIndex,
                onSelect: handleGifSelection
            }),
        !hasGiphyKey &&
            /*#__PURE__*/ _react.default.createElement(_url_fallback_dialog.URLFallbackDialog, {
                open: Boolean(selectedIndex !== null),
                onClose: removeSelectedIndex,

...
var ExperiencesEditFormWrapper = function ExperiencesEditFormWrapper(_ref3) {
    ...
    var experienceDeleted = (0, _react.useCallback)(
        function (idToDelete) {
            return function () {
                handleValueChange('work')(
                    work.filter(function (_ref4) {
                        var id = _ref4.id;
    ...
    var addExperience = (0, _react.useCallback)(
        function () {
            var id = (0, _v.default)();
            handleValueChange('work')(
                work.concat({
    ...
    var move = (0, _react.useCallback)(
        function (_ref5) {
            var oldIndex = _ref5.oldIndex,
                newIndex = _ref5.newIndex;
            handleValueChange('work')(
                (0, _reactSortableHoc.arrayMove)(work, oldIndex, newIndex).map(function (data, index) {
    ...
    var title = (0, _react.useMemo)(
        function () {
            ...
            var payload = {
                ...
                start:
                    (_experience$startDate = experience.startDate) === null || _experience$startDate === void 0
                        ? void 0
                        : _experience$startDate.format('MMMM YYYY'),
                end:
                    (_experience$endDate = experience.endDate) === null || _experience$endDate === void 0
                        ? void 0
                        : _experience$endDate.format('MMMM YYYY')
            };

            if (payload.companyName) {
                if (!payload.end) {
                    return formatMessage(
                        _experiences_edit_dialog_translations.translations.jobTitleCompanyNoEnd,
                        payload
                    );
                }

                return formatMessage(
                    _experiences_edit_dialog_translations.translations.jobTitleCompanyBothDates,
                    payload
                );
            }
            ...
            if (payload.end) {
                return formatMessage(
                    _experiences_edit_dialog_translations.translations.jobTitleNoCompanyNoEnd,
                    payload
                );
            }

            return formatMessage(
                _experiences_edit_dialog_translations.translations.jobTitleNoCompanyBothDates,
                payload
            );
        },
        [experience]
...
var ExperienceItem = (0, _reactSortableHoc.SortableElement)(function (_ref7) {
    ...
    var contentTransitions = (0, _reactSpring.useTransition)(
        !folded ? experience : null,
        function (item) {
            return ''
                .concat(item ? 'visible' : 'invisible', '_experience_')
                .concat(item === null || item === void 0 ? void 0 : item.id, '_content');
        },
...
var ContentFields = function ContentFields(_ref9) {
    ...
    var handleStillEmployedChange = (0, _react.useCallback)(
        function () {
            if (!stillEmployed) {
    ...
    var stillEmployedComponent = /*#__PURE__*/ _react.default.createElement(
        StillEmployedField,
        (0, _extends2.default)(
            {
                value: stillEmployed
    ...
    var handleNameChange = (0, _react.useCallback)(
        function (e) {
            return onChange(index, 'name', e.target.value);
        },
        [index]
    );
    var handlePositionChange = (0, _react.useCallback)(
        function (e) {
            return onChange(index, 'position', e.target.value);
        },
        [index]
    );
    var handleSummaryChange = (0, _react.useCallback)(
        function (e) {
            return onChange(index, 'summary', e.target.value);
        },
        [index]
    );
    var handleStartDate = (0, _react.useCallback)(
        function (value) {
            return onChange(index, 'startDate', value);
        },
        [index]
    );
    var handleEndDate = (0, _react.useCallback)(
        function (value) {
            return onChange(index, 'endDate', value);
        },
        [index]
    );
    var handleLocationChange = (0, _react.useCallback)(
        function (value) {
            return onChange(index, 'place', value);
        },
        [index]
    );
    var handleLocationTextChange = (0, _react.useCallback)(
        function (value) {
            ...
            /*#__PURE__*/ _react.default.createElement(
                ...
                /*#__PURE__*/ _react.default.createElement(
                    ...
                    /*#__PURE__*/ _react.default.createElement(
                        ...
                        formatMessage(_experiences_edit_dialog_translations.translations.companyName)
                    ),
                    /*#__PURE__*/ _react.default.createElement(_ui.TextField, {
                        id: 'experience_companyName_'.concat(id),
                        placeholder: formatMessage(
                            _experiences_edit_dialog_translations.translations.companyNamePlaceholder
                        ),
                    ...
                    (fieldErrors === null || fieldErrors === void 0 ? void 0 : fieldErrors.name) &&
                        /*#__PURE__*/ _react.default.createElement(
                            _ui.Typography,
                            {
                                color: 'danger',
                ...
                /*#__PURE__*/ _react.default.createElement(
                    ...
                    /*#__PURE__*/ _react.default.createElement(
                        ...
                        formatMessage(_experiences_edit_dialog_translations.translations.jobTitle)
                    ),
                    /*#__PURE__*/ _react.default.createElement(_ui.TextField, {
                        id: 'experience_jobTitle_'.concat(id),
                        placeholder: formatMessage(
                            _experiences_edit_dialog_translations.translations.jobTitlePlaceholder
                        ),
                    ...
                    (fieldErrors === null || fieldErrors === void 0 ? void 0 : fieldErrors.position) &&
                        /*#__PURE__*/ _react.default.createElement(
                            _ui.Typography,
                            {
                                color: 'danger',
            ...
            /*#__PURE__*/ _react.default.createElement(
                ...
                /*#__PURE__*/ _react.default.createElement(
                    ...
                    /*#__PURE__*/ _react.default.createElement(
                        ...
                        formatMessage(_experiences_edit_dialog_translations.translations.jobPlace)
                    ),
                    /*#__PURE__*/ _react.default.createElement(_location_field.LocationField, {
                        id: 'experience_jobPlace_'.concat(id),
                        placeholder: formatMessage(
                            _experiences_edit_dialog_translations.translations.jobPlacePlaceholder
                        ),
                        value:
                            (_experience$place = experience.place) === null || _experience$place === void 0
                                ? void 0
                                : _experience$place.name,
                        onLocationSelected: handleLocationChange,
                        onChange: handleLocationTextChange,
                        margin: 'normal',
                        variant: 'flat'
                    }),
                    (fieldErrors === null || fieldErrors === void 0 ? void 0 : fieldErrors.place) &&
                        /*#__PURE__*/ _react.default.createElement(
                            _ui.Typography,
                            {
                                color: 'danger',
                            ...
                            (fieldErrors === null || fieldErrors === void 0 ? void 0 : fieldErrors.place.name) ||
                                fieldErrors.place
                        )
                )
            ),
            ...
            /*#__PURE__*/ _react.default.createElement(
                ...
                /*#__PURE__*/ _react.default.createElement(
                    ...
                    /*#__PURE__*/ _react.default.createElement(
                        ...
                        formatMessage(_experiences_edit_dialog_translations.translations.descriptionTitle)
                    ),
                    /*#__PURE__*/ _react.default.createElement(_ui.TextField, {
                        fullWidth: true,
                        id: 'experience_description_'.concat(id),
                        placeholder: formatMessage(
                            _experiences_edit_dialog_translations.translations.descriptionPlaceholder
                        ),
                    ...
                    (fieldErrors === null || fieldErrors === void 0 ? void 0 : fieldErrors.summary) &&
                        /*#__PURE__*/ _react.default.createElement(
                            _ui.Typography,
                            {
                                color: 'danger',
    ...
    return /*#__PURE__*/ _react.default.createElement(
        'div',
        {
            className: (0, _classnames.default)(
                classes.fieldRow,
                value && (0, _classnames.default)(classes.fieldRowJustifyEnd, classes.withMarginStillEmployedFieldRow)
            )
        },
        /*#__PURE__*/ _react.default.createElement(
            'button',
...
var ExperiencesEditForm = function ExperiencesEditForm(_ref14) {
    ...
    var keyedValues = (0, _react.useMemo)(
        function () {
    ...
    var _useState = (0, _react.useState)(
            Object.keys(keyedValues || {}).reduce(function (state, id) {
    ...
    var toggleFold = (0, _react.useCallback)(
        function (id) {

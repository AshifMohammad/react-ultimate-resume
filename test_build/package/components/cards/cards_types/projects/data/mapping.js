    ...
    return {
        projects:
            jsonResume === null || jsonResume === void 0
                ? void 0
                : (_jsonResume$projects = jsonResume.projects) === null || _jsonResume$projects === void 0
                ? void 0
                : _jsonResume$projects.map(function (project, index) {
...
var updateProjectsArray = function updateProjectsArray(newProject, jsonResume) {
    ...
    if (
        !((_jsonResume$projects2 = jsonResume.projects) === null || _jsonResume$projects2 === void 0
            ? void 0
            : _jsonResume$projects2.length)
    ) {
        return {
            projects: [newProject]
        };

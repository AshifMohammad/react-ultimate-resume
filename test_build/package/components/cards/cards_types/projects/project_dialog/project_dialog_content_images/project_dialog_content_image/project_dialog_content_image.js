...
var ProjectDialogContentImageComponent = function ProjectDialogContentImageComponent(_ref) {
    ...
    var editLayerTransitions = (0, _reactSpring.useTransition)(
        showEditLayer,
        function (item) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        editLayerTransitions.map(function (_ref2) {
            ...
            return (
                item &&
                /*#__PURE__*/ _react.default.createElement(EditLayer, {
                    key: key,
                    style: props,
                    classes: classes,
                    url: url
...
var EditLayer = function EditLayer(_ref4) {
    ...
    var deleteImage = (0, _react.useCallback)(
        function () {
            setFieldValue(
                'images',
                values.images.filter(function (_ref5) {

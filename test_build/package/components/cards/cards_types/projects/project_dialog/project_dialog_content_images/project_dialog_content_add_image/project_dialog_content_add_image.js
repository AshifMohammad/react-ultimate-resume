...
var ProjectDialogContentAddImageComponent = function ProjectDialogContentAddImageComponent() {
    ...
    var onFileAdded = (0, _react.useCallback)(
        function (url) {
            return setFieldValue(
                'images',
                [].concat((0, _toConsumableArray2.default)(values.images || []), [
                    {
                        url: url
                    }
                ])
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        null,
        /*#__PURE__*/ _react.default.createElement(_url_upload_file_dialog.UrlUploadFileDialog, {
            open: openDialog,

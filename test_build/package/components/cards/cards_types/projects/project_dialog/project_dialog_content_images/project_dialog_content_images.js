...
var ProjectDialogContentImagesComponent = function ProjectDialogContentImagesComponent(_ref) {
    ...
    var handleImageClick = (0, _react.useCallback)(
        function (index) {
            return function () {
                if (isEditing) {
                    return;
    ...
    var transitions = (0, _reactSpring.useTransition)(
        ...
        _objectSpread(
            {},
            _project_dialog_content_images_transitions_spring_props.PROJECT_DIALOG_CONTENT_IMAGES_TRANSITIONS_SPRING_PROPS,
            {},
            isEditing && {
                immediate: true,
                trail: 0
    ...
    var navButtonStyles = (0, _react.useCallback)(
        function (base) {
            return _objectSpread({}, base, {
                ...
                color: (0, _styles_utils.getHexFromPaletteColor)(
                    theme,
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        isEditing &&
            /*#__PURE__*/ _react.default.createElement(
                _project_dialog_content_add_image.ProjectDialogContentAddImage,
                null
            ),

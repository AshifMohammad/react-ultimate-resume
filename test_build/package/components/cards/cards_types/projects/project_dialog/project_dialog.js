...
var ProjectDialogComponent = function ProjectDialogComponent(_ref) {
    ...
    var onDialogEdited = (0, _react.useCallback)(
        function (editedData) {
            var updateProjectsArray1 = (0, _mapping.updateProjectsArray)(
                (0, _mapping.mapProjectToJsonResume)(editedData),
                resume
            );
...
var ProjectDialogContent = function ProjectDialogContent(_ref2) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement(
            _project_dialog_content_description.ProjectDialogContentDescription,
            {
                isEditing: isEditing,

...
var RemoveIcon = function RemoveIcon(props) {
    return /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement('path', {
                d:
                    'M25.304 14.697L14.697 25.302M14.697 14.697l10.607 10.605M20 1.25c10.356 0 18.75 8.395 18.75 18.75S30.357 38.75 20 38.75 1.25 30.357 1.25 20 9.645 1.25 20 1.25z',
                strokeWidth: '2.50005'
            })
        )
    );
...
var ProjectSectionContainer = function ProjectSectionContainer(_ref) {
    ...
    var descriptionChunks = (0, _react.useMemo)(
        function () {
            var _project$description;

            return (_project$description = project.description) === null || _project$description === void 0
                ? void 0
                : _project$description.split('\n').map(function (descriptionChunk, chunkIndex) {
                      return /*#__PURE__*/ _react.default.createElement(
                          'p',
                          {
    ...
    var formattedDate = (0, _react.useMemo)(
        function () {
            var _project$date;
...
var Details = function Details(_ref2) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        isEditing &&
            /*#__PURE__*/ _react.default.createElement(RemoveProjectDetail, {
                color: color,
                index: index,
                onDelete: onDelete,
                classes: classes
...
var RemoveProjectDetail = function RemoveProjectDetail(_ref3) {
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        null,
        /*#__PURE__*/ _react.default.createElement(_confirm_dialog.ConfirmDialog, {
            open: openDialog,

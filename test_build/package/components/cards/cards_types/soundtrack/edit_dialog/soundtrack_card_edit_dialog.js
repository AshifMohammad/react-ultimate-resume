...
var Content = function Content(_ref2) {
    ...
    var frameHashCode = (0, _react.useMemo)(
        function () {
    ...
    var handleFieldChange = (0, _react.useCallback)(
        function (event) {
            ...
            if (!value.includes('/embed')) {
                finalValue = ''
                    .concat(value.substring(0, SPOTIFY_DOMAIN.length), '/embed/')
                    .concat(value.substring(SPOTIFY_DOMAIN.length + 1, value.length));
            }
    ...
    var clearField = (0, _react.useCallback)(
        function () {
            setFieldValue('embedUrl', '');
        },
        [setFieldValue]
    );
    var isValidUrl = (0, _react.useMemo)(
        function () {
            return (
                URL_REGEX.test(iframeUrl) &&
                (iframeUrl === null || iframeUrl === void 0 ? void 0 : iframeUrl.includes('/embed'))
            );
        },
        [iframeUrl]
    );
    ...
    return /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement(
            ...
            hasLoaded === null && /*#__PURE__*/ _react.default.createElement(_loading_spinner.LoadingSpinner, null),
            iframeUrl &&

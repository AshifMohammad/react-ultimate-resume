...
var SkillsFrontComponent = function SkillsFrontComponent(_ref) {
        ...
        function () {
            ...
            var firstTechno =
                data === null || data === void 0
                    ? void 0
                    : (_data$skills = data.skills) === null || _data$skills === void 0
                    ? void 0
                    : _data$skills[0];
            ...
            return (
                technologies[firstTechno === null || firstTechno === void 0 ? void 0 : firstTechno.name] || {
                    name: firstTechno === null || firstTechno === void 0 ? void 0 : firstTechno.name
                }
            );
        },
    ...
    var hasSkill = (0, _react.useMemo)(
        function () {
            return (0, _exists_and_not_empty.existsAndNotEmpty)(
                data === null || data === void 0 ? void 0 : data.skills
            );
        },
        [data]
    );
...
var Picture = function Picture(_ref3) {
    ...
    var src = (0, _react.useMemo)(
        function () {
            var hex = (0, _styles_utils.getHexFromPaletteColor)(theme, backgroundColor);
            var luminance = (0, _chromaJs.default)(hex).luminance();

            if (luminance < 0.98) {
                return 'https://process.filestackapi.com/output=format:png/negative/modulate=brightness:1000/compress/'.concat(
                    (techno === null || techno === void 0 ? void 0 : techno.handle) || _icons.DEFAULT_TECHNO_HANDLE
                );
            }

            return 'https://process.filestackapi.com/output=format:png/'.concat(
                (techno === null || techno === void 0 ? void 0 : techno.handle) || _icons.DEFAULT_TECHNO_HANDLE
            );
        },

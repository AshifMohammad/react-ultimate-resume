...
var ShareIcon = function ShareIcon(props) {
    return /*#__PURE__*/ _react.default.createElement(
        ...
        /*#__PURE__*/ _react.default.createElement('path', {
            d:
                'M6 17C8.269 7.119 17 5.333 17 5.333V2l7 6.637-7 6.696V12s-6.17-.171-11 5zm12 .145V20H2V8h6.598a16.999 16.999 0 0 1 2.339-2H0v16h20v-6.769l-2 1.914z'
        })
    );
};
...
var SHARE_LINKS_DATA = Object.freeze({
    ...
    copyShareUrl: {
        icon: function icon(props) {
            ...
            return /*#__PURE__*/ _react.default.createElement(
                _copy_wrapper.CopyWrapper,
                {
                    value:
                        (_location = (typeof window === 'undefined' ? {} : window).location) === null ||
                        _location === void 0
                            ? void 0
                            : _location.href
                },

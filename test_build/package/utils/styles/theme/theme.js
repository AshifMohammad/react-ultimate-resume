...
var _palettes = _interopRequireDefault(require('@welovedevs/ui/styles/palettes'));
...
var getRandomCardVariant = function getRandomCardVariant(theme) {
    ...
    return Math.floor(
        Math.random() *
            ((_theme$components = theme.components) === null || _theme$components === void 0
                ? void 0
                : (_theme$components$car = _theme$components.cards) === null || _theme$components$car === void 0
                ? void 0
                : (_theme$components$car2 = _theme$components$car.variants) === null ||
                  _theme$components$car2 === void 0
                ? void 0
                : _theme$components$car2.length)
    );
};

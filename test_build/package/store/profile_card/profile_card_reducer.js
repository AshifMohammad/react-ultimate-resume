...
var getProfileCardInitialState = function getProfileCardInitialState() {
    ...
    return Object.freeze({
        hasDialogOpened:
            (_initialValues$hasDia = initialValues.hasDialogOpened) !== null && _initialValues$hasDia !== void 0
                ? _initialValues$hasDia
                : false,
        side:
            (_initialValues$side = initialValues.side) !== null && _initialValues$side !== void 0
                ? _initialValues$side
                : 'front',
        variant:
            (_initialValues$varian = initialValues.variant) !== null && _initialValues$varian !== void 0
                ? _initialValues$varian
                : null
    });
};
